...
**중요**: 전문가스럽게 말투일 경우 특히 디테일하고 전문적으로 작성하세요.
- interpretation: 각 detail은 최소 5-6문장으로 상세히
- herbalife_solution.daily_routine: 각 제품의 why와 how를 구체적으로 (각 3-4문장)
- fat_management, muscle_metabolism: 각 포인트를 상세히 (각 4-5문장)
- coach_script: 5-7문장으로 실전 상담처럼 풍부하게
...
**필수 필드 및 상세 요구사항**:
- one_line_summary: 핵심을 담은 한 문장
- metrics: 배열 - 위 수치 그대로 7개 항목
- interpretation: 배열 3개 - 각 detail은 최소 4-6문장으로 상세히
- herbalife_solution:
  * daily_routine: 아침/점심/저녁 각 2-3개 제품, 각 why/how는 2-3문장씩
  * fat_management: 2-3개 항목, 각 point/action/product_suggestion을 상세히 (각 3-4문장)
  * muscle_metabolism: 2-3개 항목, 각 point/action/product_suggestion을 상세히 (각 3-4문장)
  * compliance_note: 면책 문구
- coach_script: 배열 5-7문장 - 실전 코칭처럼 풍부하고 구체적으로
- guide_4weeks: 배열 4개 주차 - 각 focus와 checkpoints 3개씩
- sms_result: 250-300자 문자 내용

**중요**: 말투가 "전문가스럽게"일 경우 특히 더 디테일하고 전문적으로 작성하세요.
제품 추천 시 구체적인 제품명, 가격, 섭취법을 포함하세요.

JSON 시작 { 과 끝 } 만 출력하세요. 설명이나 주석 없이.`
